        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php?id=<?php echo $row['id']; ?>">
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" placeholder="Modifique el Nombre" class="form-control" name="firstname" value="<?php echo $row['firstname']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" placeholder="Modifique el Apellido" class="form-control" name="lastname" value="<?php echo $row['lastname']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" placeholder="Modifique la Dirección" class="form-control" name="address" value="<?php echo $row['address']; ?>">
					</div>
				</div>
            </div> 
			</div>
